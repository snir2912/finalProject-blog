...
const UsersListItem = user => {
  ...
  return (
    <>
      <div className='p-8 mb-4  shadow rounded'>
        <div className='flex flex-wrap items-center -mx-4'>
          <div className='w-full lg:w-3/12 flex px-4 mb-6 lg:mb-0'>
            ...
            <div>
              ...
              <p className='text-xs text-gray-200'>{user?.user?.email}</p>
            </div>
          </div>
          ...
          <div className='w-1/2 lg:w-2/12 px-4 mb-6 lg:mb-0'>
            <p className='text-sm font-medium'>
              <span className='text-base mr-2  text-bold text-gray-200'>
          ...
          <div className='w-full flex lg:w-4/12 px-4  mb-6 lg:mb-0'>
            <p className='inline-block py-1 px-2 mr-2 mb-1 lg:mb-0 text-xs border-2 rounded'>
              <span className='text-base mr-2  boder-2 text-bold text-gray-200'>
                {user.user?.posts?.length} - Posts
              </span>
            </p>
            <Link
              to={`/profile/${user?.user?._id}`}
              className=' text-gray-200 inline-block py-1 px-2 text-center mr-2 mb-1 lg:mb-0 text-xs border-2 border-+yellow-500 rounded hover:bg-yellow-500 hover:text-white'
            >
              Profile
            </Link>
            ...
            <button
              ...
              className='inline-flex  justify-center bg-green-500 px-2 border border-green-500 shadow-sm text-sm font-medium rounded-md text-gray-700  hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500'
            >
              <MailIcon
